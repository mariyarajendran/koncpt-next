...
import app.technotech.koncpt.databinding.FragmentSubjectWiseTestBinding;
...
public class SubjectWiseTestFragment extends Fragment implements TestListener, GrandTestRecyclerAdapter.OnItemClickListener, CustomBuyNowDialogFragment.OnNavigateToScreen {

    private Context mContext;
    private View mView;
    private FragmentSubjectWiseTestBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_subject_wise_test, container, false);
    ...
    private void loadData() {
        ...
        binding.revSubjectWiseTest.setLayoutManager(new LinearLayoutManager(getActivity()));
        binding.revSubjectWiseTest.setItemAnimator(new DefaultItemAnimator());
        GrandTestRecyclerAdapter recyclerAdapter = new GrandTestRecyclerAdapter(mContext, list, this);
        binding.revSubjectWiseTest.setAdapter(recyclerAdapter);
...
TTI, 18:441. subjectbookmarks = https://koncptkritatechnosolutions.in/api/v1/user/subjectbookmarks + "/\(id)"
        2 bookmarks_all = https://koncptkritatechnosolutions.in/api/v1/user/bookmarks + "/\(id)"
        3. bookmarks_subject_question = https://koncptkritatechnosolutions.in/api/v1/user/bookmarks-subject-question

        let param = ["subject_id”:””,
        "user_id”:””] as [String : Any]

        4. bookMark_Delete = https://koncptkritatechnosolutions.in/api/v1/bookmarks/delete/ + "\(book_id)"
