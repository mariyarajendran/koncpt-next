...
import app.technotech.koncpt.databinding.FragmentAllTestBinding;
...
public class AllTestFragment extends Fragment implements TestListener, GrandTestRecyclerAdapter.OnItemClickListener, CustomBuyNowDialogFragment.OnNavigateToScreen {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_all_test, container, false);
    ...
    private void loadData() {
        ...
        binding.revAllTest.setLayoutManager(new LinearLayoutManager(getActivity()));
        binding.revAllTest.setItemAnimator(new DefaultItemAnimator());
        GrandTestRecyclerAdapter recyclerAdapter = new GrandTestRecyclerAdapter(mContext, list, this);
        binding.revAllTest.setAdapter(recyclerAdapter);
