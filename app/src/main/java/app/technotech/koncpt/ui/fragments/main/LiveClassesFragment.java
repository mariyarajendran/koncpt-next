...
public class LiveClassesFragment extends Fragment implements LiveClassRecyclerAdapter.OnItemClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding.setSubjectViewMode(model);
         binding.rltSavedClass.setOnClickListener(new View.OnClickListener() {
             @Override
             public void onClick(View v) {
                 Navigation.findNavController(binding.getRoot()).navigate(R.id.downloadFragment);

             }
         });

         binding.relativeLiveClass.setOnClickListener(new View.OnClickListener() {
             @Override
