...
import app.technotech.koncpt.databinding.FragmentGrandTestBinding;
...
public class GrandTestFragment extends Fragment implements TestListener, GrandTestRecyclerAdapter.OnItemClickListener, CustomBuyNowDialogFragment.OnNavigateToScreen {


    private Context mContext;
    private View mView;
    private FragmentGrandTestBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_grand_test, container, false);
    ...
    private void loadData() {
        ...
        binding.revGrandTest.setLayoutManager(new LinearLayoutManager(getActivity()));
        binding.revGrandTest.setItemAnimator(new DefaultItemAnimator());
        GrandTestRecyclerAdapter recyclerAdapter = new GrandTestRecyclerAdapter(mContext, list, this);
        binding.revGrandTest.setAdapter(recyclerAdapter);
