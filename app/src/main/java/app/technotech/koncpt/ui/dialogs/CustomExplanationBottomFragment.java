...
public class CustomExplanationBottomFragment extends BottomSheetDialogFragment {

    private BottomSheetCustomExaplanationBinding binding;
    private BookmarkViewModel model;
    private GeneralUtils utils;
    private AlertDialog progressDialog;
    private CustomExamModel.Datum quesItem;
    ...
    public CustomExplanationBottomFragment() {
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            quesItem = new Gson().fromJson(getArguments().getString("Data"), new TypeToken<CustomExamModel.Datum>() {
            }.getType());
