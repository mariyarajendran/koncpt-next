...
public class SubjectWiseTestAdapter extends RecyclerView.Adapter<SubjectWiseTestAdapter.TestViewHolder> {

    private ArrayList<TestEntity> mTestEntities;

    private static TestListener mListener;

    public SubjectWiseTestAdapter(TestListener testListener) {
    ...
    public TestViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new SubjectWiseTestAdapter.TestViewHolder(view);
    }
