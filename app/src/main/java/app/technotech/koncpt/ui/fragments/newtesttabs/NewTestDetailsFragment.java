...
public class NewTestDetailsFragment extends Fragment {
    ...
    private NewTestViewPagerAdapter mPagerAdapter;
    private View mView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_new_test_details, container, false);
    ...
    private void setTabLayout() {
        mPagerAdapter = new NewTestViewPagerAdapter(getActivity(), getChildFragmentManager(), binding.tabLayout.getTabCount(), subjectId, subjectTitle, levelId);
