...
public class MiniTestAdapter extends RecyclerView.Adapter<MiniTestAdapter.TestViewHolder> {

    private ArrayList<TestEntity> mTestEntities;

    private static TestListener mListener;

    public MiniTestAdapter(TestListener testListener) {
    ...
    public TestViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new MiniTestAdapter.TestViewHolder(view);
    }
