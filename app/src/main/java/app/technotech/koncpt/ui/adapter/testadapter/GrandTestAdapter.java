...
public class GrandTestAdapter extends RecyclerView.Adapter<GrandTestAdapter.TestViewHolder> {

    private ArrayList<TestEntity> mTestEntities;

    private static TestListener mListener;

    public GrandTestAdapter(TestListener testListener) {
    ...
    public TestViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new GrandTestAdapter.TestViewHolder(view);
    }
